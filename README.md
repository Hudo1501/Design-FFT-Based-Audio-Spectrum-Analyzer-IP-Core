...
A full IEEE-style write-up — theoretical background, architecture, verification methodology,
results, and PPA characterization — accompanies this repository.

```bibtex
@misc{vu2026fftr2sdf,
  author       = {Anh Quoc Vu and Hung Dong Truong and Hoang Nguyen Huy Le and
                  Minh Duy Nguyen and Duyen Vu Ky Nguyen and Loc Duy Lam},
  title        = {Design, Bit-Exact Verification, and {PPA} Characterization of a
                  256-Point {R2SDF} {FFT} Audio Spectrum Analyzer {IP} Core on {Zynq-7000}},
  year         = {2026},
  howpublished = {\url{https://github.com/Hudo1501/Design-FFT-Based-Audio-Spectrum-Analyzer-IP-Core}},
  note         = {COS201 --- Communication Systems, course project}
}
```
...
The authors thank the COS201 teaching staff and the project group for discussions on the
verification strategy and for reviewing the latency derivation. The repository was
reorganised and documented by a team member with assistance from Claude (Anthropic).
